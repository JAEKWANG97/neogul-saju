...
const MAX_OUTPUT_TOKENS = 1500;    // 출력 토큰 상한 (비용 캡)
...
function buildPrompt(body) {
  ...
  const topicGuide = {
    ...
    overall: [
      "종합사주는 타고난 기질, 관계를 맺는 방식, 돈과 일에서 반복되는 습관, 올해와 오늘에 같이 적용되는 기본 사용법을 중심으로 쓴다.",
      "단편 운세보다 깊게 읽되, 사용자가 자신의 성향을 이해하고 바로 써먹을 수 있는 생활 해석으로 풀어낸다."
    ],
    love: [
  ...
  const lines = [
    ...
    "- 예: '불기운이 앞서간다'를 '생각보다 말이 먼저 문밖으로 나가는 날'처럼 현실감 있게 풀어 쓴다.",
    "- 너굴 사주의 브랜드 톤에 맞게 살짝 재치 있게 쓰되, 유치한 농담이나 인터넷 밈은 쓰지 않는다.",
    "- 각 결과 안에 최소 두 번은 사용자가 자기 얘기처럼 느낄 만한 구체적 장면을 넣는다.",
    "- 구체적 장면은 카톡 답장, 회의 한마디, 지갑을 여는 순간, 약속 시간, 메모장, 엘리베이터 앞 짧은 대화처럼 생활감 있는 소재를 활용한다.",
    "- 단, 재미가 해석의 깊이를 방해하면 안 된다. 웃기려고 과장하지 말고, 비유로 이해를 돕는다.",
    "",
    "결과 작성 규칙:",
    ...
    "- 종합사주는 summary를 조금 더 깊게 쓰고, 기질/관계/돈/일의 반복 패턴이 모두 한 번씩 보이게 한다.",
  ...
  return lines.concat([
    "JSON 스키마:",
    "{",
    '  "topic": "종합사주|오늘운세|애정운|재물운|직장운|궁합|신년운세",',
    '  "title": "품격 있는 짧은 제목",',
